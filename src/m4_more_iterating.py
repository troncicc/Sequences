...
def sum_sequence(sequence):
    ...
    for k in range(len(sequence)):
        summation = sequence[k] + summation
    return summation
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 1
    actual = count_positive_sines([0, math.pi, math.pi*2])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 12
    actual = sum_first_n([5, 3, 4, 1, 9, 90, 322], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 9
    actual = sum_first_n([9, 0, 0, 0, 9], 1)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
